          ...
          <div className="bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 rounded-3xl p-12 border-4 border-yellow-400 shadow-2xl max-w-md mx-4 text-center">
            <div className="mb-6">
              ...
              <p className="text-purple-200 text-lg mb-6">
                {t('Connect your wallet to enter the game world')}
              </p>
            </div>
            
            <div className="bg-black/30 rounded-xl p-6 mb-6 border-2 border-purple-500/50">
              <p className="text-white mb-2">{t('Play tower defense games')}</p>
              <p className="text-white mb-2">{t('Collect tower NFTs')}</p>
              <p className="text-white mb-2">{t('Create monster challenges')}</p>
              <p className="text-white">{t('Trade on marketplace')}</p>
            </div>

            <div className="text-yellow-300 font-bold text-lg animate-pulse">
              {t('Click "Connect Wallet" button above to start!')}
            </div>
          </div>
        </div>
      )}
      ...
      >
        ...
        <div className="md:hidden grid grid-cols-2 gap-4 max-w-md mx-auto pt-20">
          <Link href="/lucky-draw" className="flex flex-col items-center p-4 bg-black/20 rounded-xl hover:bg-black/30 transition-all">
            <img src="/luckydraw.png" alt={t('Lucky Draw')} className="w-24 h-auto mb-2" />
            <span className="text-white font-bold text-sm">{t('Lucky Draw')}</span>
          </Link>
          <Link href="/challenge-list" className="flex flex-col items-center p-4 bg-black/20 rounded-xl hover:bg-black/30 transition-all">
            <img src="/challenge.png" alt={t('Challenge')} className="w-24 h-auto mb-2" />
            <span className="text-white font-bold text-sm">{t('Challenge')}</span>
          </Link>
          <Link href="/play" className="flex flex-col items-center p-4 bg-black/20 rounded-xl hover:bg-black/30 transition-all col-span-2">
            <img src="/game.png" alt={t('Game Arena')} className="w-32 h-auto mb-2" />
            <span className="text-white font-bold">{t('Game Arena')}</span>
          </Link>
          <Link href="/my-towers" className="flex flex-col items-center p-4 bg-black/20 rounded-xl hover:bg-black/30 transition-all">
            <img src="/tower.png" alt={t('My Bag')} className="w-24 h-auto mb-2" />
            <span className="text-white font-bold text-sm">{t('My Bag')}</span>
          </Link>
          <Link href="/market" className="flex flex-col items-center p-4 bg-black/20 rounded-xl hover:bg-black/30 transition-all">
            <img src="/marketplace.png" alt={t('Market')} className="w-24 h-auto mb-2" />
          ...
          <Link href="/history" className="flex flex-col items-center p-4 bg-black/20 rounded-xl hover:bg-black/30 transition-all col-span-2">
            <img src="/history.png" alt={t('History')} className="w-20 h-auto mb-2" />
            <span className="text-white font-bold text-sm">{t('History')}</span>
          </Link>
        </div>
        ...
        <Link 
          ...
          onMouseEnter={() => setHoveredBuilding(t('Game Arena'))}
        ...
        <Link 
          ...
          onMouseEnter={() => setHoveredBuilding(t('Lucky Draw'))}
          onMouseLeave={() => setHoveredBuilding(null)}
        >
          <img 
            src="/luckydraw.png" 
        ...
        <Link 
          ...
          onMouseEnter={() => setHoveredBuilding(t('Challenge Hall'))}
          onMouseLeave={() => setHoveredBuilding(null)}
        >
          <img 
            src="/challenge.png" 
            alt={t('Challenge Hall')} 
            className="md:w-60 h-auto drop-shadow-2xl"
          />
        </Link>
        ...
        <Link 
          ...
          onMouseEnter={() => setHoveredBuilding(t('My Towers'))}
          onMouseLeave={() => setHoveredBuilding(null)}
        >
          <img 
            src="/tower.png" 
        ...
        <Link 
          ...
          onMouseEnter={() => setHoveredBuilding(t('Marketplace'))}
          onMouseLeave={() => setHoveredBuilding(null)}
        >
          <img 
            src="/marketplace.png" 
        ...
        <Link 
          ...
          onMouseEnter={() => setHoveredBuilding(t('History Board'))}
          onMouseLeave={() => setHoveredBuilding(null)}
        >
          <img 
            src="/history.png" 
